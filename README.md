...
| Token | Value | Usage |
|-------|-------|-------|
| `--ink` | `#2C2420` | Sidebar, hero backgrounds |
| `--gld` | `#B8860B` | Accent, highlights, CTAs |
| `--c` | `#F9F7F2` | Main content background |
| `--bdr` | `#E5E0D8` | Borders, dividers |
| Serif | Cormorant Garamond | Headings, display text |
| Sans | Montserrat | Body, navigation, labels |

## Sections

| # | Section | Content |
|---|---------|---------|
| 01 | **Home** | Hero, key metrics, hybrid value proposition, navigation cards |
| 02 | **About** | Executive summary, achievements, education, CompTIA A+, LinkedIn recommendation |
| 03 | **Skills** | Operational, technical, and leadership capabilities with proficiency indicators |
| 04 | **Experience** | 5-year Dubai STR career timeline with documented P&L outcomes |
| 05 | **Work & Cases** | Live project showcase: FixHub, GuestCare, GGS Platform |
| 06 | **Contact** | Contact details, target roles, GitHub, LinkedIn, CV download |

## Key Metrics Showcased

- **350+** rental units under management
- **+25%** tenant satisfaction improvement
- **-40%** maintenance response time reduction
...
[![GitHub](https://img.shields.io/badge/View%20All%20Projects-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/princechakusa)
